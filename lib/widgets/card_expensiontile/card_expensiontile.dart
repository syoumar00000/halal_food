...
class CardExpensionTile extends StatefulWidget {
  const CardExpensionTile({super.key});

  @override
  State<CardExpensionTile> createState() => _CardExpensionTileState();
}

class _CardExpensionTileState extends State<CardExpensionTile> {
    ...
    return ClipRRect(
      ...
      child: ExpansionTile(
        ...
        children: [
          RadioGroup<int>(
            groupValue:
                _selectedCardIndex, // 👈 Déplacé ici ! Reçoit la valeur sélectionnée actuelle
            onChanged: (int? newIndex) {
              // 👈 Déplacé ici ! Déclenché au clic sur n'importe quel Radio
              if (newIndex != null) {
                setState(() {
                  _selectedCardIndex = newIndex;
                });
                // 💡 Optionnel : Mettre à jour votre Provider ici si nécessaire
                // creditCardState.selectCard(creditCardState.cards[newIndex]);
              }
            },
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Radio<int>(
                          value:
                              index, // 👈 Identifie ce bouton radio de manière unique
