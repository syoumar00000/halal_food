          ...
          products.isNotEmpty
                  ...
                  child: Padding(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        final bool isSvg = iconPath.toLowerCase().endsWith(
                          '.svg',
                        );
              ...
              : Expanded(
                  child: EmptyContainer(
                    title: "Favourites are Empty!",
                    subTitle:
                        "You can save your favourite by clicking on the heart mark in the offers",
                    labelButton: "Discover Offers",
                  ),
                ),
        ],
      ),
